...
function Modal({ onClose }) {
  const [form, setForm] = useState({ name: "", phone: "", address: "", service: "Wash and Fold", date: "" });
      ...
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        {done ? (
          <div className="done">
            ...
            <p>Hi <b>{form.name}</b>! We will call <b>{form.phone}</b> to confirm your pickup on <b>{form.date}</b>.</p>
            <p className="done-sub">Sit back and relax we will handle the rest!</p>
          ...
          <>
            <div className="modal-header">
              <h2>Book a Pickup</h2>
              <p>We will come to you. Fill in your details below.</p>
            </div>
...
export default function App() {
  ...
  const ticker = ["Wash and Fold", "Wash and Iron", "Dry Cleaning", "Bedding and Linen", "Free Pickup and Delivery", "24hr Turnaround", "Serving Nairobi", "SMS Updates", "5 Star Service", "Eco Friendly"];
    ...
    <div className="app">
      ...
      <section className="hero">
        <div className="hero-left">
          <span className="pill">Serving Nairobi and Beyond</span>
          <div className="hero-rating">
            <span>5 Stars</span>
            <span className="rating-text">Rated 4.9 out of 5 by over 2000 Nairobi customers</span>
          </div>
          ...
          <div className="hero-actions">
            <button className="btn lg pulse" onClick={open}>Schedule a Pickup</button>
            <a href="#how" className="link-btn">See how it works</a>
          </div>
          <div className="trust-bar">
            <div className="trust-item">
              <span className="trust-num">2000+</span>
        ...
        <div className="hero-right">
          ...
          <div className="hero-float">Free Pickup and Delivery</div>
        </div>
      </section>
      ...
      <section className="services" id="services">
        ...
        <div className="service-grid">
          {[
            { icon: "🫧", title: "Wash and Fold", desc: "Machine washed tumble dried and neatly folded for you.", img: "https://images.unsplash.com/photo-1582735689369-4fe89db7114c?w=400&q=80" },
            { icon: "👔", title: "Wash and Iron", desc: "Washed and pressed to perfection. Ready to wear.", img: "https://images.unsplash.com/photo-1517677208171-0bc6725a3e60?w=400&q=80" },
            ...
            { icon: "🏠", title: "Bedding and Linen", desc: "Duvets bedsheets and towels cleaned and freshened up.", img: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=400&q=80" },
          ].map((s, i) => (
      ...
      <section className="pricing" id="pricing">
        ...
        <div className="price-grid">
          {[
            { name: "Basic", price: "Ksh 500", kg: "Up to 5kg", features: ["Wash and Fold", "Free Pickup", "Free Delivery", "24hr Turnaround"], popular: false },
            { name: "Standard", price: "Ksh 900", kg: "Up to 10kg", features: ["Wash and Iron", "Free Pickup", "Free Delivery", "Priority Service", "SMS Updates"], popular: true },
            { name: "Premium", price: "Ksh 1500", kg: "Unlimited", features: ["Full Service", "Dry Cleaning", "Bedding Included", "Same Day Option", "SMS Updates"], popular: false },
          ].map((p, i) => (
      ...
      <Fade className="why-us">
        <div className="why-text">
          ...
          <h2>We Make Laundry <span className="accent">Effortless</span></h2>
          <div className="why-list">
            {[
              ...
              { icon: "🔒", title: "Safe and Insured", desc: "Every item in our care is fully tracked and insured for your peace of mind." },
      ...
      <footer className="footer" id="contact">
        <div className="footer-grid">
          ...
          <div>
            <h4>Services</h4>
            <a href="#services">Wash and Fold</a>
            <a href="#services">Wash and Iron</a>
            <a href="#services">Dry Cleaning</a>
            <a href="#services">Bedding and Linen</a>
          </div>
          <div>
            <h4>Company</h4>
          ...
          <div>
            ...
            <p>Nairobi Kenya</p>
            <p>0792 570 400</p>
            <p>nimoh@spinlaundry.co.ke</p>
            <p>Mon to Sat 7am to 8pm</p>
          </div>
        </div>
