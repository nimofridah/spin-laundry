...
function Fade({ children, className = "" }) {
  ...
  return <div ref={ref} className={`fade ${visible ? "fade-in" : ""} ${className}`}>{children}</div>;
}
      ...
      <section className="hero">
        <div className="hero-left">
          ...
          <div className="trust-bar">
            <div className="trust-item"><span className="trust-num">2,000+</span><span>Happy Customers</span></div>
            <div className="divider" />
            <div className="trust-item"><span className="trust-num">24hrs</span><span>Turnaround Time</span></div>
            <div className="divider" />
            <div className="trust-item"><span className="trust-num">4.9 ⭐</span><span>Average Rating</span></div>
          </div>
        </div>
